<template>
  <form class="app-reserve" @submit.prevent="submit">
    <div class="app-reserve__checks">
      <h4 class="app-reserve__section-title">Забронировать столик</h4>

      <label
        v-for="table in tables"
        :key="table.id"
        class="app-reserve__check check"
        :class="{
          'check--red': table.type === 'vip',
          'check--disabled': table.booked
        }"
      >
        <input
        ...
        <span class="check__label">{{ table.id }} стол</span>
      </label>
    </div>

    <div class="app-reserve__scheme">
      <div class="app-reserve__scheme-container">
        <h4 class="app-reserve__scheme-title">Сцена</h4>

        <div class="app-reserve__scheme-wrapper">
          <svg class="scene" viewBox="0 0 780 399" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g class="scene__table scene__table--red">
              <g class="scene__table-group" stroke="#BC3324"><rect x="507.5" y="35.5" width="83" height="28"/><circle cx="527" cy="20" r="11.5"/><circle cx="570" cy="20" r="11.5"/><circle cx="606" cy="48" r="11.5"/><circle cx="570" cy="79" r="11.5"/><circle cx="527" cy="79" r="11.5"/></g>
            ...
            <g class="scene__table">
              <g class="scene__table-group" stroke="#1F1E1E"><rect x="712.5" y="4.5" width="40" height="93"/><circle cx="697" cy="16" r="11.5"/><circle cx="768" cy="17" r="11.5"/><circle cx="697" cy="49" r="11.5"/><circle cx="768" cy="50" r="11.5"/><circle cx="697" cy="82" r="11.5"/><circle cx="768" cy="83" r="11.5"/><circle cx="733" cy="113" r="11.5"/></g>
            ...
            <g class="scene__table">
              <g class="scene__table-group" stroke="#1F1E1E"><rect x="712.5" y="185.5" width="40" height="93"/><circle cx="697" cy="197" r="11.5"/><circle cx="768" cy="198" r="11.5"/><circle cx="697" cy="230" r="11.5"/><circle cx="768" cy="231" r="11.5"/><circle cx="697" cy="263" r="11.5"/><circle cx="768" cy="264" r="11.5"/><circle cx="733" cy="294" r="11.5"/></g>
            ...
            <g class="scene__table scene__table--red">
              <g class="scene__table-group" stroke="#BC3324"><rect x="507.5" y="182.5" width="83" height="28"/><circle cx="527" cy="167" r="11.5"/><circle cx="570" cy="167" r="11.5"/><circle cx="606" cy="195" r="11.5"/><circle cx="570" cy="226" r="11.5"/><circle cx="527" cy="226" r="11.5"/></g>
            ...
            <g class="scene__table">
              <g class="scene__table-group" stroke="#1F1E1E"><rect x="494.5" y="278.5" width="40" height="93"/><circle cx="479" cy="290" r="11.5"/><circle cx="550" cy="291" r="11.5"/><circle cx="479" cy="323" r="11.5"/><circle cx="550" cy="324" r="11.5"/><circle cx="479" cy="356" r="11.5"/><circle cx="550" cy="357" r="11.5"/><circle cx="515" cy="387" r="11.5"/></g>
            ...
            <g class="scene__table">
              <g class="scene__table-group" stroke="#1F1E1E"><rect x="273.5" y="278.5" width="40" height="93"/><circle cx="258" cy="290" r="11.5"/><circle cx="329" cy="291" r="11.5"/><circle cx="258" cy="323" r="11.5"/><circle cx="329" cy="324" r="11.5"/><circle cx="258" cy="356" r="11.5"/><circle cx="329" cy="357" r="11.5"/><circle cx="294" cy="387" r="11.5"/></g>
            ...
            <g class="scene__table scene__table--red">
              <g class="scene__table-group" stroke="#BC3324"><rect x="320.5" y="183.5" width="83" height="28"/><circle cx="383" cy="227" r="11.5"/><circle cx="419" cy="197" r="11.5"/><circle cx="305" cy="197" r="11.5"/><circle cx="340" cy="227" r="11.5"/></g>
            ...
            <g class="scene__table scene__table--red">
              <g class="scene__table-group" stroke="#BC3324"><rect x="187.5" y="169.5" width="61" height="36"/><circle cx="216" cy="221" r="11.5" transform="rotate(-180 216 221)"/><circle cx="171" cy="185" r="11.5" transform="rotate(-180 171 185)"/><circle cx="216" cy="154" r="11.5" transform="rotate(-180 216 154)"/></g>
            ...
            <g class="scene__table scene__table--red">
              <g class="scene__table-group" stroke="#BC3324"><rect x="222.5" y="27.5" width="61" height="36"/><circle cx="251" cy="79" r="11.5" transform="rotate(-180 251 79)"/><circle cx="206" cy="43" r="11.5" transform="rotate(-180 206 43)"/><circle cx="251" cy="12" r="11.5" transform="rotate(-180 251 12)"/></g>
            ...
            <g class="scene__table">
              <g class="scene__table-group" stroke="#1F1E1E"><path d="M110.5 65V0.5H141.5V64.8261V92.5H15.5V65.5H110H110.5V65Z"/><circle cx="27" cy="50" r="11.5"/><circle cx="61" cy="50" r="11.5"/><circle cx="94" cy="50" r="11.5"/><circle cx="94" cy="16" r="11.5"/></g>
            ...
            <g class="scene__table">
              <g class="scene__table-group" stroke="#1F1E1E"><rect x="27.5" y="185.5" width="40" height="93"/><circle cx="12" cy="197" r="11.5"/><circle cx="83" cy="198" r="11.5"/><circle cx="12" cy="230" r="11.5"/><circle cx="83" cy="231" r="11.5"/><circle cx="12" cy="263" r="11.5"/><circle cx="83" cy="264" r="11.5"/><circle cx="48" cy="294" r="11.5"/></g>
    ...
    <div class="app-reserve__order">
      <h4 class="app-reserve__section-title">Ваши пригласительные билеты</h4>

      <div class="app-reserve__tickets-list">
        <div class="app-reserve__tickets">
          <span class="app-reserve__qty">{{ vipSelected.length }} шт. | {{ vipPrice }}₽</span>
          <span class="app-reserve__sum">{{ vipTotal }} ₽</span>
        </div>
        <div class="app-reserve__tickets">
          <span class="app-reserve__qty">{{ commonSelected.length }} шт. | {{ commonPrice }}₽</span>
          <span class="app-reserve__sum">{{ commonTotal }} ₽</span>
        </div>
      </div>

      <div class="app-reserve__total">Сумма {{ total }} ₽</div>
      <button type="submit" class="btn btn--red app-reserve__submit">Купить билеты</button>
    </div>

    <div class="app-reserve__legend">
      <h4 class="app-reserve__section-title">Стоимость пригласительного билета</h4>

      <div class="app-reserve__tickets-prices">
        <div class="app-reserve__price">
          <span class="app-reserve__vip"></span>
          <span class="app-reserve__pricing">{{ vipPrice }}₽ | 1 персона</span>
        </div>
        <div class="app-reserve__price">
          <span class="app-reserve__cmn"></span>
          <span class="app-reserve__pricing">{{ commonPrice }}₽ | 1 персона</span>
        </div>
      </div>

      <div class="app-reserve__comments">
        <h4 class="app-reserve__section-title">Примечание</h4>

        <div class="app-reserve__comment">
          <span class="app-reserve__place app-reserve__place--cmn"></span>
          <span class="app-reserve__place app-reserve__place--vip"></span>
          <span class="app-reserve__note">доступные места</span>
        </div>
        <div class="app-reserve__comment">
          <span class="app-reserve__locked"></span>
          <span class="app-reserve__note">забронировано</span>
        </div>
      </div>
    </div>
  </form>
...
<script setup>
const vipPrice = 1400;
const commonPrice = 1250;

const tables = reactive([
  { id: 1,  type: 'vip',    booked: false, selected: true  },
  { id: 2,  type: 'common', booked: false, selected: false },
  { id: 3,  type: 'common', booked: false, selected: false },
  { id: 4,  type: 'vip',    booked: false, selected: false },
  { id: 5,  type: 'common', booked: true,  selected: false },
  { id: 6,  type: 'common', booked: false, selected: false },
  { id: 7,  type: 'vip',    booked: false, selected: true  },
  { id: 8,  type: 'vip',    booked: false, selected: false },
  { id: 9,  type: 'vip',    booked: false, selected: false },
  { id: 10, type: 'common', booked: false, selected: true  },
  { id: 11, type: 'common', booked: false, selected: false },
]);

const vipSelected    = computed(() => tables.filter(t => t.type === 'vip'    && t.selected));
const commonSelected = computed(() => tables.filter(t => t.type === 'common' && t.selected));
const vipTotal       = computed(() => vipSelected.value.length * vipPrice);
const commonTotal    = computed(() => commonSelected.value.length * commonPrice);
const total          = computed(() => vipTotal.value + commonTotal.value);

const submit = () => {
  const selected = tables.filter(t => t.selected);
  console.log('Заказ:', selected, 'Сумма:', total.value);
  alert(`Заказ оформлен на сумму ${total.value} ₽`);
};
</script>
